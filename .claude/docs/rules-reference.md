...
| `yjackcore-unity.md` | `Packages/YJackCore/**`, `Packages/com.ygamedev.yjack/**` | YJackCore layer boundaries, specialist precedence, workspace routing, inspector-first authoring, package integrity, manual validation |
