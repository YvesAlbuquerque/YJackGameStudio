...
read `.claude/docs/yjackcore-support.md` before proposing managers, wrappers,
...
| `src/**` or `Assets/**` and YJackCore is active | `.claude/docs/yjackcore-support.md` rules + unity-specialist fallback (§1b) |
...
6. `.claude/docs/technical-preferences.md` contains `- **Framework**: YJackCore`
...
2. .claude/docs/yjackcore-support.md (this repo's support doc)
3. .claude/rules/yjackcore-unity.md (path-scope rules)
