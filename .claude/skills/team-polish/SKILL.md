...
- Generate idempotent child issues for: design, architecture, implementation, tests, Art/Audio/UX discipline work, and QA (mark N/A only when truly out of scope).
