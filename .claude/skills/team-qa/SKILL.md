...
- Generate idempotent child issues for: design, architecture, implementation, tests, QA support track already primary; use UX/Art/Audio as needed by scope discipline work, and QA (mark N/A only when truly out of scope).
